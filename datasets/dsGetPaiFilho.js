/**
 * @Dataset Busca Dadoos Tabela Pai e Filho
 * @param {string[]} fields Campos Solicitados
 * @param {Constraint[idFormulario,Nome Dataset Formulario , Nome Tabela Pai e Filho]} constraints Filtros
...
function createDataset(fields, constraints, sorts) {
    ...
    try {
        ...
        var mgsError = 'dsGetPaiFilho - ERRO:' + error + ',LINE:' + e.lineNumber;

        dataset.addColumn('SUCCESS');
        dataset.addColumn('MESSAGE');
        dataset.addRow([false , mgsError]);
        log.error(mgsError);
